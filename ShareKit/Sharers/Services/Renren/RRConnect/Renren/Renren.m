...
+ (Renren *)newRenRen{
    ...
    newRenrenObject.appKey = @"406457ad9904400eaf76e92958dd9658";
    newRenrenObject.appId = @"201845";
...
+ (Renren *)sharedRenren {
    if (!sharedRenren) {
        ...
        sharedRenren.appKey = @"406457ad9904400eaf76e92958dd9658";
        sharedRenren.appId = @"201845";
    }
    return sharedRenren;
}
